...
describe("A600 Hardie motion preview", () => {
  ...
  it("keeps motion bounded and honors reduced-motion preferences", () => {
  ...
  it("labels conceptual status and physical-sample boundary", () => {
    expect(component).toContain("Concept render · physical sample required");
