 ...
 *
 * This file is the single source of truth for public-facing copy used by the
 * homepage. It intentionally contains no backend wiring, no form endpoints, no
 * analytics, no provider configuration, no live project data, and no PII.
 *
 * PREVIEW SCOPE: nothing on this site collects, submits, emails, stores,
 * tracks, routes, calls, records, or sends information. All CTAs are disabled
 * controls or in-page anchors until explicit Owner approval.
 */
...
export const siteConfig = {
  ...
  sections: {
    ...
    activeProjects: {
      eyebrow: "Active projects preview",
