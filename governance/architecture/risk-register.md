...
| R-11 | A provider, script, or public surface exposes Spanish or Russian automated voice despite the English-only policy | Brand / language | Medium | DR-0016 policy test; any future public routing allowlist must contain English only; ES/RU remain internal/operator capabilities |
...
| R-14 | Support burden of a custom hybrid stack exceeds a small team's capacity | Operational complexity | Medium | Sequencing keeps vendor-independent lab first; production readiness requires a later owner gate |
