...
| R-11 | A provider, script, or public surface exposes Spanish or Russian automated voice despite the English-only policy | Brand / language | Medium | DR-0016 policy test; public routing allowlist contains English only; ES/RU remain internal/operator capabilities |
