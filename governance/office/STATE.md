...
Updated: 2026-08-04c — rebased onto main d02be35 (DR-0015/DR-0016 landed via PR #30)
...
| C governance (Claude) | Studio config schema v0.1 shipped (binding for TASK-0013) | REVIEW of next builder PR | Owner decisions below |
